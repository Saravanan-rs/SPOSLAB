...
int main()
{
    ...
    fclose(f1);
    f3=fopen("interin1.txt","r");
    f5=fopen("output_linker.txt","w");
    char str2[60];
    i=0;
     while(!feof(f3))
    {
    ...
    f4=fopen("interin2.txt","r");
    f5=fopen("output_linker.txt","a");
    line=0;
    i=0;
      while(!feof(f2))
    {
